        ...
        <section className='lg:mx-24 my-12 grid grid-cols-1 gap-6 justify-items-center'>
            ...
            <div class="card max-w-screen-lg bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <p>If you directly update it, using setState() subsequently may just overwrite the update you did it.This.state does not change instantly when you directly update the state. Instead, it generates a pending state transition, which will only return the current value when accessed after calling this function.</p>
                </div>
            </div>
        </section>
    );
